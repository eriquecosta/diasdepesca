...
O `HomeStore` gera marcações **Bom**, **Ruim** e **Intermediário** com as regras abaixo:
...
As regras de cálculo e mapeamento por data estão implementadas em `HomeStore`. Veja `lib/app/modules/home/home_store.dart`.
