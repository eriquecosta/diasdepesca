...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
    id: const obx_int.IdUid(1, 4944654211690182472),
    name: 'WeatherLocalModel',
    lastPropertyId: const obx_int.IdUid(3, 4064490188965331336),
    flags: 0,
    properties: <obx_int.ModelProperty>[
      obx_int.ModelProperty(
        id: const obx_int.IdUid(1, 1242123223360095577),
        name: 'id',
        type: 6,
        flags: 1,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(2, 2437253076302807342),
        name: 'cachedAt',
        type: 10,
        flags: 0,
      ),
      obx_int.ModelProperty(
        id: const obx_int.IdUid(3, 4064490188965331336),
        name: 'payloadJson',
        type: 9,
        flags: 0,
      ),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
    ...
    entities: _entities,
    lastEntityId: const obx_int.IdUid(1, 4944654211690182472),
  ...
  final bindings = <Type, obx_int.EntityDefinition>{
    WeatherLocalModel: obx_int.EntityDefinition<WeatherLocalModel>(
      ...
      objectToFB: (WeatherLocalModel object, fb.Builder fbb) {
        ...
        fbb.addInt64(1, object.cachedAt.millisecondsSinceEpoch);
        fbb.addOffset(2, payloadJsonOffset);
...
class WeatherLocalModel_ {
  ...
  static final id = obx.QueryIntegerProperty<WeatherLocalModel>(
    _entities[0].properties[0],
  );

  /// See [WeatherLocalModel.cachedAt].
  static final cachedAt = obx.QueryDateProperty<WeatherLocalModel>(
    _entities[0].properties[1],
  );

  /// See [WeatherLocalModel.payloadJson].
  static final payloadJson = obx.QueryStringProperty<WeatherLocalModel>(
